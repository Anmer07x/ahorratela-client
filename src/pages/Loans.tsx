      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-100 flex items-center gap-2">
            <HandCoins className="text-brand-400" /> Préstamos
          </h2>
          <p className="text-slate-400 text-sm mt-1">Gestiona el dinero que has prestado y sus intereses</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="card-stat">
          ...
          <div className="flex items-end justify-between">
            <h3 className="text-2xl font-black text-white">{stats?.total_loans || 0}</h3>
        ...
        <div className="card-stat">
          ...
          <div className="flex items-end justify-between">
            <h3 className="text-2xl font-black text-white">{formatCurrency(stats?.total_principal || 0)}</h3>
        ...
        <div className="card-stat">
          <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Total a Recuperar</p>
          <div className="flex items-end justify-between">
            <h3 className="text-2xl font-black text-brand-400">{formatCurrency(stats?.total_to_recover || 0)}</h3>
            <div className="w-8 h-8 rounded-lg bg-brand-500/20 flex items-center justify-center text-brand-400 shadow-glow-green/20">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          {isLoading && loans.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 bg-surface-800/50 rounded-3xl border border-dashed border-white/10 text-center px-6">
              ...
              <p className="text-slate-500 text-sm mt-1 max-w-xs">Registra un nuevo préstamo en el formulario para empezar el seguimiento.</p>
            </div>
          ) : (
