...
export default function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-surface-900 text-slate-200">
      <Sidebar />
      <main className="flex-1 overflow-y-auto min-h-screen relative pb-20 md:pb-0">
        
        {/* Mobile Header (Solo visible en celular) */}
        <div className="md:hidden flex items-center justify-between p-4 bg-surface-800/90 backdrop-blur-md border-b border-white/5 sticky top-0 z-30 shadow-xl">
